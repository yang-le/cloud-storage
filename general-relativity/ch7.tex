...
\hline
$GL(m, \mathbb{C})$ & 一般线性群（复） & 连通 & $m \times m$可逆复矩阵 & $m^2$ & $m \times m$任意实矩阵 \\
\hline
$SL(m)$ & 特殊线性群（实） & 连通 & 行列式为$1$的$m \times m$可逆实矩阵 & $m^2$ & $m \times m$任意实矩阵 \\
\hline
$SL(m, \mathbb{C})$ & 特殊线性群（复） & 连通 & 行列式为$1$的$m \times m$可逆复矩阵 & $m^2$ & $m \times m$任意实矩阵 \\
\hline
$O(m)$ & 正交群 & 不连通 & 正交实矩阵 & $m^2$ & $m \times m$任意实矩阵 \\
\hline
$SO(m)$ & 转动群（特殊正交群） & 连通 & 行列式为$1$的正交实矩阵 & $m^2$ & $m \times m$任意实矩阵 \\
\hline
$O(1, 3)$ & 洛伦兹群 & 不连通 & $m \times m$可逆实矩阵 & $m^2$ & $m \times m$任意实矩阵 \\
\hline
$L^\uparrow_+$ & 固有洛伦兹群 & 连通 & $m \times m$可逆实矩阵 & $m^2$ & $m \times m$任意实矩阵 \\
\hline
$U(m)$ & 酉群 & 连通 & $m \times m$可逆实矩阵 & $m^2$ & $m \times m$任意实矩阵 \\
\hline
$SU(m)$ & 特殊酉群 & 连通 & $m \times m$可逆实矩阵 & $m^2$ & $m \times m$任意实矩阵 \\
\hline\hline
\end{tabular}
\end{table}
